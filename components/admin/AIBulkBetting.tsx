            ...
            {openDraws.length > 0 ? (
                <div className="space-y-6">
                    ...
                    <div>
                         ...
                         <div className="flex flex-wrap gap-x-4 gap-y-2 bg-brand-surface p-3 rounded-lg border border-brand-secondary">
                            {(Object.keys(BettingCondition) as Array<keyof typeof BettingCondition>).map((key) => (
                                <label key={key} className="flex items-center space-x-2 text-brand-text cursor-pointer">
                                    <input
                                        ...
                                        className="form-radio h-4 w-4 text-brand-accent bg-brand-bg border-brand-secondary focus:ring-brand-accent"
                                    />
